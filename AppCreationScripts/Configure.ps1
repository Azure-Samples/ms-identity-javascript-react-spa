...
Function ConfigureApplications {
    ...
    Write-Host "Done creating the spa application (ms-identity-javascript-react-spa)"
    ...
    Add-Content -Value "<tr><td>spa</td><td>$currentAppId</td><td><a href='$spaPortalUrl'>ms-identity-javascript-react-spa</a></td></tr>" -Path createdApps.html
    ...
    $configFile = $pwd.Path + "\..\src\authConfig.js"
    Write-Host "Updating the sample code ($configFile)"
    $dictionary = @{ "Enter_the_Application_Id_Here" = $spaAadApplication.AppId; "Enter_the_Cloud_Instance_Id_HereEnter_the_Tenant_Info_Here" = "https://login.microsoftonline.com/common"; "Enter_the_Redirect_Uri_Here" = $spaAadApplication.Spa.RedirectUris[0]; "Enter_the_Graph_Endpoint_Here" = 'https://graph.microsoft.com/' };
